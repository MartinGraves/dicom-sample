...
# https://cuhimaging-dicom-ms.dicom.azurehealthcareapis.com/
# curl -X GET --header "Authorization: Bearer $token"  https://cuhimaging-dicom-ms.dicom.azurehealthcareapis.com/v1/changefeed
base_url = f"https://cuhimaging-dicom-ms.dicom.azurehealthcareapis.com/v1"
